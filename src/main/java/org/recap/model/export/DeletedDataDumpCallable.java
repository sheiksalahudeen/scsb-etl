...
@Service
@Scope("prototype")
public class DeletedDataDumpCallable implements Callable {
    ...
    public Object call() throws Exception {
        ...
        List<BibliographicEntity> bibliographicEntityList = dataDumpCallableHelperService.getDeletedRecords(pageNum,batchSize,dataDumpRequest,bibliographicDetailsRepository);
