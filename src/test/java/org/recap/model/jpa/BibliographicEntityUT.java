...
public class BibliographicEntityUT extends BaseTestCase {
    ...
    public void duplicateBibWithDifferentHoldingsItemsAndKeepOld() {
        ...
        if (null != matchedBib) {
            bibliographicEntity2.getHoldingsEntities().addAll(matchedBib.getHoldingsEntities());
            bibliographicEntity2.getHoldingsEntities().add(holdingsEntity2);

            bibliographicEntity2.getItemEntities().addAll(matchedBib.getItemEntities());
            bibliographicEntity2.getItemEntities().add(itemEntity2);
        } else {
            bibliographicEntity2.getHoldingsEntities().addAll(Arrays.asList(holdingsEntity2));
            bibliographicEntity2.getItemEntities().addAll(Arrays.asList(itemEntity2));
        }
